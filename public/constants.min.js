...
Portfolio.constants=function(){return{pages:["Home","Skills","Experience","Demos","Blog"],page_text:{home:{title:"Jacob Friesen - Web Developer",introduction:"Hello, I'm a Computer Science Honours Co-op student from the University of Manitoba. \t\t\t\t\t\t\t   Currently I'm in a school term. My specialties are in scripting languages and web development. \t\t\t\t\t\t\t   I will graduate by April 2013. I have worked in Django, Ruby on Rails, Java (JSF), and Node.js \t\t\t\t\t\t\t   environments.",specialty_title:"Specialties",
