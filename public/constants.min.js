...
"Used ExtJS, AJAX and some HTML/CSS to design the front end interfaces, with backend code mainly in Python with some JavaScript\t\t\t\t\t\t\t(Titanium Studio Libraries) and ZPL.","Additionally, improved system perfomance in an important area by a factor of 2 and added a way to save all window placement \t\t\t\t\t\t\tstate between sessions. See the demo description of the Iders IMS website.","All work was done in Ubuntu (Linux variant)."]},{position:"Web Developer",company:"AAFC",date:"January 2011 - April 2011",
details:["Redesigned and managed the back end of all the Rural Water Resources Planner website's tools using Java.","Redesigned and managed the front end (client side) of the website using a mix of JSF, HTML/CSS, and Javascript. \t\t\t\t\t\t\tThe client side development mainly involved designing graphical user interfaces for the website's tools.","Participated in defining user experience, page designs, software architecture and other web application essentials \t\t\t\t\t\t\tfor the whole website.",
...
image:["images/contactList_s.jpg","Jacob Friesen Contact List Picture"],links:[{link_text:"C# Source Code (Zipped): ",link:["http://www.jacobfriesen.com/downloads/contactList.zip","Jacob Friesen Contact List Download"]}]}]},blog:{title:"Blog - Jacob Friesen",introduction:"Below is the latest text posting from my coding blog. View my full blog",introduction_link:["http://epiccode.tumblr.com/","here","Jacob Friesen's Tumblr Blog"]}}}}();"undefined"!==typeof module&&(module.exports=Portfolio.constants);
